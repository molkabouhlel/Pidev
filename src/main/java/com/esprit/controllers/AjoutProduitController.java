...
public class AjoutProduitController implements Initializable {
    ...
    void addProduit(ActionEvent event) throws IOException {
        ...
        String categorie = id_categorie.getValue();
        Categorie C=cs.rechercheCategorienom(categorie);
        ...
        ps.ajouter(new Produit(tfDescription.getText(), tf_Prix, tf_Quantite, tfMarque.getText(), C, tfurl.getText(), tfsku.getText()));
