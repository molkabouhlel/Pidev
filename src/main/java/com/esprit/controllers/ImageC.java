...
import com.esprit.models.likeanddislike;
...
// Crée le bouton "like" avec l'image de fond
        Button like = createStyledButton("", "file:C:/Users/thebe/OneDrive/Bureau/workshopjdbc/src/main/resources/img/ic_love_.png", "pink", 30, 30);
        like.setOnAction(e -> likeaction(e, vBox));

        Button dislike = createStyledButton("", "file:C:/Users/thebe/OneDrive/Bureau/workshopjdbc/src/main/resources/img/ic_angry.png", "#87CEEB", 30, 30);
...
//style
    ...
    void goback(ActionEvent event) throws IOException {
        ...
        currentStage.close();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Frontactiviteruser.fxml"));
