...
public Equipement(){}
    //constructeur ajout
    public Equipement(String ref_eq, String nom_eq, String description_eq, int quantite_dispo,  Espace id_espace, Categorie_eq id_ceq, Maintenance_eq id_m, String image) {
        this.ref_eq = ref_eq;
        this.nom_eq = nom_eq;
    ...
    public Equipement(int id_eq, String ref_eq, String nom_eq, String description_eq, int quantite_dispo, Espace id_espace, Categorie_eq id_ceq, Maintenance_eq id_m, String image) {
       this.id_eq= id_eq;
        this.ref_eq = ref_eq;
        this.nom_eq = nom_eq;
        this.description_eq = description_eq;
