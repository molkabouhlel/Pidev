...
public class ProduitService implements IService<Produit> {
    ...
    public List<String> Recuperernom() {
        ...
        String req = "SELECT description_produit from produit";

        try {
            Statement st = connection.createStatement();
            ResultSet rs = st.executeQuery(req);
            while (rs.next()) {
                C.add(rs.getString("description_produit"));
            }
    ...
    public Produit rechercheCategorienom(String descriptionprod) {
        Produit Produit = null;
        CategorieService cs=new CategorieService();

        String req = "SELECT * FROM produit WHERE description_produit = '" + descriptionprod + "'";
        try {
            Statement st = connection.createStatement();
            ResultSet rs = st.executeQuery(req);
            if (rs.next()) {
                ...
                Produit.setDesc(rs.getString("description_produit"));
                Produit.setPrix(rs.getFloat("prix"));
                Produit.setQuant(rs.getInt("quantite_produit"));
                Produit.setMarque(rs.getString("marque"));
              Categorie C= cs.rechercheCategorieid(rs.getInt("id_categorie"));
                Produit.setId_categorie(C);
                Produit.setImage(rs.getString("image"));
                Produit.setSku(rs.getString("sku"));
